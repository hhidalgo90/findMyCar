...
export class RegistroUsuarioPage implements OnInit {
  ...
  constructor(public loadingCtrl: LoadingController, private router: Router, private firebaseService : FirebaseService, public alertCtrl: AlertController) { }
  ...
  async registrarUsuario(): Promise<void> {
    ...
    this.firebaseService.registrarUsuario(this.nombre, this.edad, this.email, this.sexo, this.passUser).then(resp =>{
      console.log(resp);
